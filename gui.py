...
def _emit_to_bridge(message: str) -> None:
    if bridge is None:
        return
    for signal_name in ("log_signal", "status_signal"):
        ...
        try:
            ...
            logger.debug("Failed to emit %s via GUI bridge", signal_name, exc_info=True)
